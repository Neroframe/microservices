...
const file_test_proto_rawDesc = "" +
	...
	"\vTestService\x123\n" +
	"\bSayHello\x12\x12.test.HelloRequest\x1a\x13.test.HelloResponseBMZKgithub.com/Neroframe/ecommerce-platform/inventory-service/proto/test;testpbb\x06proto3"
...
var file_test_proto_depIdxs = []int32{
	0, // 0: test.TestService.SayHello:input_type -> test.HelloRequest
	1, // 1: test.TestService.SayHello:output_type -> test.HelloResponse
