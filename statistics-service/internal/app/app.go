...
import (
	...
	natsadapter "github.com/Neroframe/ecommerce-platform/statistics-service/internal/adapter/nats/handler"
...
// App holds all application components for the statistics service.
type App struct {
	grpcServer   *grpcadapter.API
	natsConsumer *natsconsumer.PubSub
}

// New wires up all dependencies and returns an App instance without starting it.
...
// Run starts the gRPC server and NATS consumer, blocking until an error or OS signal.
