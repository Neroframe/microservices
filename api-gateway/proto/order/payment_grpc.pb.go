...
const (
	PaymentService_CreatePayment_FullMethodName  = "/order.PaymentService/CreatePayment"
	PaymentService_GetPaymentByID_FullMethodName = "/order.PaymentService/GetPaymentByID"
)
