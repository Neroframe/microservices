...
type UpdateOrderStatusRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Status        string                 `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"` // Order status (e.g., "pending", "completed")
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_order_proto_rawDesc = "" +
	...
	"\x0eListUserOrders\x12\x18.order.ListOrdersRequest\x1a\x19.order.ListOrdersResponseBEZCgithub.com/Neroframe/ecommerce-platform/order-service/proto;orderpbb\x06proto3"
...
var file_proto_order_proto_depIdxs = []int32{
	...
	5, // 8: order.OrderService.GetOrderByID:output_type -> order.OrderResponse
	5, // 9: order.OrderService.UpdateOrderStatus:output_type -> order.OrderResponse
